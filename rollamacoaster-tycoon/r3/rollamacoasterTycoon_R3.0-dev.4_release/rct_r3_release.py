...
def main():
    ...
    required=['R3 DEVELOPMENT TEST LOOP','/api/dev/core-dump','rollamacoaster-r3','/api/tags','/api/chat','REVISION 3','R3.0-dev.4','updateKeyboardCamera(dt)','WASD camera translation']
