#!/bin/sh
set -eu
IMAGE=rct-r5-dev6; NAME=rct-r5; PORT=${R5_PORT:-8765}; CODEX=${CODEX_PATH_HOST:-$HOME/Documents/codex.json}; ROOT=$(CDPATH= cd -- "$(dirname -- "$0")" && pwd); DATA=$ROOT/data
logo(){ printf '\n🎢 R5 dev.6  🧭 runtime v2  📖 external Codex\n'; }
