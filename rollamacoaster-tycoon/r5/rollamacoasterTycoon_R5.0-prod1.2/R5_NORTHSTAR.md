...
R5.0-prod1.2 retires `world-runtime-v9-stability-gate` as the active runtime primitive and replaces it with `world-kernel-v10-cellular`. Persisted v9 world meaning remains readable as migration input. The production primitive registry is `world/primitives.json`.
